...
- `prompts.py`: Single source for all system/agent prompts—keep long prompt text here.
...
- Store prompt strings in `prompts.py`; use f-strings; keep logging concise (Rich already colors output).
